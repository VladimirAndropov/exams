...
with open(log_file, 'r') as file:
    ...
    file.seek(0, 2)
    # Читаем строки с конца, останавливаемся после чтения первой строки
    previous_runs = sum(1 for line in reversed(list(file)))
    # Печатаем количество предыдущих запусков в stderr
