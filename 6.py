# Эта программа создает пул из 5 процессов с помощью multiprocessing.Pool. 
# Затем она создает список значений x от 0 до 1 с шагом 0.1 и распределяет вычисления между процессами, 
# передавая им подмассивы значений x для вычисления функции calculate(x, 2). 
# Результаты вычислений сохраняются в списке results, который затем выводится на экран.
