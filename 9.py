# Эта программа использует модуль subprocess для выполнения команды netstat -tuln, которая выводит список открытых портов на машине. 
# Затем программа обрабатывает вывод команды, извлекая номера портов, и выводит их на экран.
import subprocess
